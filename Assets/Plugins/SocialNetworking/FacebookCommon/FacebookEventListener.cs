...
public class FacebookEventListener : MonoBehaviour
{
	...
	void facebookReauthorizationWithReadPermissionsFailedEvent( string error )
	{
		Debug.Log( "facebookReauthorizationWithReadPermissionsFailedEvent: " + error );
	}


	void facebookReauthorizationWithReadPermissionsSucceededEvent()
	{
		Debug.Log( "facebookReauthorizationWithReadPermissionsSucceededEvent" );
	}


	void facebookReauthorizationWithPublishPermissionsFailedEvent( string error )
	{
		Debug.Log( "facebookReauthorizationWithPublishPermissionsFailedEvent: " + error );
	}


	void facebookReauthorizationWithPublishPermissionsSucceededEvent()
	{
