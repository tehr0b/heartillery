...
public class Chef : MonoBehaviour 
{
	...
	public void Attack(Vector3 worldPosition)
	{
		...
		boneAnimation.Play("QuickAttack_" + UnityEngine.Random.Range(1, (_currentWeapon.weaponType == Weapon.WEAPON_TYPE.Cleaver ? 3 : 4)).ToString("00"));
    }
    ...
    /// </summary>
    public void PickUpWeapon(Weapon.WEAPON_TYPE weaponType)
    {
        ...
        switch (_currentWeapon.weaponType)
        {
            ...
            case Weapon.WEAPON_TYPE.Cleaver:
                // change the texture of all animation clips and all bones in our animation
                // from the rolling pin texture to the knife texture
                //
