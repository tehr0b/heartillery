...
public class Pasta : MonoBehaviour 
{
            ...
            if (_state != value)
            {
                ...
                switch (_state)
                {
                    ...
                    case STATE.Dying:
                        ...
                        _gameManager.fxManager.Activate(FX.FX_TYPE.Pizza_Splat, _thisTransform.position, (int)UnityEngine.Random.Range(-1.0f, 1.0f), "");
                        _liveAnimation.Stop();
    ...
    public void Hit(Vector3 collisionPoint, float damage)
    {
        ...
        if (_state != STATE.Hitting)
        {
            ...
            _gameManager.fxManager.Activate(FX.FX_TYPE.Sauce, _thisTransform.position, (int)(_thisTransform.position.x - _gameManager.chef.Position.x), "");
